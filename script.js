...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const menuData = [
        { id: 1, name: 'Espresso Origen Único', price: '2.80€', category: 'cafe_caliente', image: 'https://images.unsplash.com/photo-1579992305413-a433c43709b4?q=80&w=1887&auto=format=fit=crop', description: 'Un shot intenso y aromático de nuestro café de temporada, extraído para resaltar sus notas de cata únicas.', allergens: 'Ninguno', flavorProfile: { Acidez: 80, Cuerpo: 70, Dulzor: 60, Amargor: 40 } },
        { id: 2, name: 'Cappuccino Cremoso', price: '3.50€', category: 'cafe_caliente', image: 'https://images.unsplash.com/photo-1517256064527-09c73b6b5e44?q=80&w=1887&auto=format=fit=crop', description: 'El equilibrio perfecto entre espresso intenso, leche vaporizada y una capa sedosa de espuma. Ideal para una mañana reconfortante.', allergens: 'Lácteos. Opción de leche vegetal disponible.', flavorProfile: { Acidez: 60, Cuerpo: 85, Dulzor: 75, Amargor: 30 } },
        { id: 3, name: 'Cold Brew Suave', price: '4.20€', category: 'cafe_frio', image: 'https://images.unsplash.com/photo-1517701550927-4e4b7da195c3?q=80&w=1887&auto=format=fit=crop', description: 'Nuestro café infusionado en frío durante 18 horas, resultando en una bebida suave, refrescante y con baja acidez. Servido con hielo.', allergens: 'Ninguno', flavorProfile: { Acidez: 30, Cuerpo: 60, Dulzor: 80, Amargor: 20 } },
        { id: 4, name: 'Tarta de Zanahoria Casera', price: '4.80€', category: 'bolleria', image: 'https://images.unsplash.com/photo-1621994153187-52d4b8f17e79?q=80&w=1887&auto=format=fit=crop', description: 'Bizcocho esponjoso con zanahoria fresca y nueces, cubierto con un frosting de queso crema suave. El acompañante perfecto.', allergens: 'Gluten, lácteos, frutos secos.', flavorProfile: { Acidez: 10, Cuerpo: 70, Dulzor: 90, Amargor: 5 } },
        { id: 5, name: 'Latte Vainilla & Canela', price: '3.90€', category: 'cafe_caliente', image: 'https://images.unsplash.com/photo-1576092762791-d07a4a618286?q=80&w=1887&auto=format=fit=crop', description: 'Un abrazo en una taza. Nuestro latte cremoso con sirope de vainilla natural y una pizca de canela.', allergens: 'Lácteos. Opción vegetal disponible.', flavorProfile: { Acidez: 40, Cuerpo: 80, Dulzor: 85, Amargor: 25 } },
        { id: 6, name: 'Iced Caramel Macchiato', price: '4.50€', category: 'cafe_frio', image: 'https://images.unsplash.com/photo-1563830831196-6815809a84a2?q=80&w=1887&auto=format=fit=crop', description: 'Capas deliciosas de leche, espresso y sirope de caramelo, servido sobre hielo. Refrescante y dulce.', allergens: 'Lácteos. Opción vegetal disponible.', flavorProfile: { Acidez: 50, Cuerpo: 70, Dulzor: 90, Amargor: 35 } },
        { id: 7, name: 'Croissant de Almendras', price: '3.00€', category: 'bolleria', image: 'https://images.unsplash.com/photo-1591384841505-1a06b0d61663?q=80&w=1910&auto=format=fit=crop', description: 'Croissant artesanal hojaldrado, relleno de una rica crema de almendras y cubierto con almendras laminadas.', allergens: 'Gluten, lácteos, frutos secos.', flavorProfile: { Acidez: 5, Cuerpo: 60, Dulzor: 85, Amargor: 10 } }
    ];
